...
# ── 1: API route ─────────────────────────────────────────────────────────────
API_DIR = r"C:\HDCS_Project\03\GNI_Autonomous\src\app\api\source-health"
...
with open(API_FILE, "w", encoding="utf-8") as f:
    f.write(api_content)
print("OK API route written: src/app/api/source-health/route.ts")

# ── 2: Page ──────────────────────────────────────────────────────────────────
PAGE_DIR = r"C:\HDCS_Project\03\GNI_Autonomous\src\app\source-health"
...
print("OK Page written: src/app/source-health/page.tsx")
print("\nOK Both files written")
print("Next: add to nav, build, push")
