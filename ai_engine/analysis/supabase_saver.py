...
def save_report(report: dict, articles: list[dict], quality_score: float = 0, quality_breakdown: dict = None) -> str | None:
    ...
    try:
        ...
        record = {
            ...
            "analysis_runs": int(report.get("analysis_runs", 1)),
            "lat": lat,
            "lng": lng,
            ...
            "mad_black_swan_case": report.get("mad_black_swan_case", ""),
            "mad_ostrich_case": report.get("mad_ostrich_case", ""),
            ...
            "mad_blind_spot": report.get("mad_blind_spot", ""),
            "mad_action_recommendation": report.get("mad_action_recommendation", ""),
            "short_focus_threats": report.get("short_focus_threats", ""),
            "long_shoot_threats": report.get("long_shoot_threats", ""),
            "short_verify_days": report.get("short_verify_days", 14),
            "long_verify_days": report.get("long_verify_days", 180),
            "mad_round1_positions": report.get("mad_round1_positions", {}),
            "mad_round2_positions": report.get("mad_round2_positions", {}),
