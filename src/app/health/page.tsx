    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
          ...
          <>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[{ label: 'Supabase', status: 'Connected' }, { label: 'Groq API', status: 'Active' }, { label: 'Vercel', status: 'Live' }, { label: 'Telegram', status: 'Live' }].map(item => (
      ...
      <footer className="border-t border-gray-800 mt-12">
        <div className="max-w-6xl mx-auto px-6 py-4 text-center text-xs text-gray-600">
          GNI Autonomous | Health Dashboard | Higher Diploma in Computer Science | Spring University Myanmar (SUM)
        </div>
      </footer>
    </div>
  )
