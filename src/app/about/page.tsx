        ...
        <div className="bg-gray-900 border border-gray-700 rounded-xl p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <a href="/about/devops" className="bg-purple-950 border border-purple-800 hover:border-purple-600 rounded-xl p-5 transition-colors group">
              ...
              <p className="text-xs text-gray-400 leading-relaxed">How GNI runs itself. All 4 GitHub Actions pipelines, the self-healing heartbeat, the 70-pattern security layer, and live token quota data proving .00/month L7 autonomous operation.</p>
