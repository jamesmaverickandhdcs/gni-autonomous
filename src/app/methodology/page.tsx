        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              ...
              { stage: 'Stage 1b', title: 'Injection Detection', desc: 'Every article passes a 7-layer adversarial-content defense: Unicode/NFKC normalization, prompt-boundary detection, source-credibility scoring, 70-pattern injection scan, hardened-JSON response guardian, input language normalization, and SHA-256 audit chain. Flagged articles written to audit_trail table.' },
