        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              ...
              { stage: 'Stage 1b', title: 'Injection Detection', desc: '81 prompt injection patterns scanned across 7 layers: Unicode norm, source credibility, context boundary, NER, Groq hardened JSON, output sanitization, audit trail. Flagged articles written to audit_trail table.' },
