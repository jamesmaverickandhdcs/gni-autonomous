      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-purple-950 border border-purple-700 border-l-4 border-l-purple-400 rounded-xl p-5 mb-6">
          ...
          <p className="text-sm text-gray-100 leading-relaxed">
            ...
            Every component of the autonomous pipeline is observable here — from the 81-pattern injection security filter to the A/B prompt quality system and the self-healing adaptive engine.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          {[
            ...
            { href: '/security',     emoji: '🛡️', num: '04', label: 'Security', desc: '81 injection patterns actively blocked at Stage 1b of the pipeline with SHA-256 audit chain for tamper detection. Full pentest results and security audit trail available. GNI’s security layer ensures all 42 RSS sources are validated before any content reaches the AI analysis stage.', status: 'LIVE' },
            { href: '/source-health',emoji: '📡', num: '05', label: 'Source Health',desc: 'Live status of all 42 RSS sources: healthy, degraded, or down. Dynamic trust weights adjusted by GPVS prediction accuracy are shown per source. Mini sparkline charts reveal each source’s reliability trend over the last 7 days.', status: 'LIVE' },
          ...
          <a href="/mission-control" className="bg-gray-900 border border-gray-700 hover:border-purple-500 hover:bg-purple-950 rounded-xl p-4 transition-colors group">
            ...
            <div className="flex justify-end mt-3">
              <span className="text-xs font-bold text-purple-200 bg-purple-900 hover:bg-purple-700 border border-purple-700 rounded-lg px-3 py-1.5 transition-colors">View Mission Control →</span>
            </div>
          </a>
