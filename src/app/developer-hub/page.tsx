      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          {[
            ...
            { href: '/source-health',emoji: '\u{1F4E1}', num: '05', label: 'Source Health',desc: 'Live status of all 42 RSS sources: healthy, degraded, or down. Dynamic trust weights adjusted by GPVS prediction accuracy are shown per source. Mini sparkline charts reveal each source reliability trend over the last 7 days.', status: 'LIVE' },
