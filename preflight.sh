...
echo ""
echo "========================================"
echo "🧠 CLAUDE SELF-AWARENESS CHECK (GNI-R-233)"
echo "========================================"
echo "❌ NEVER conclude before reading actual files"
echo "❌ FAMILIAR/EASY = THE TELL: a past-bug match OR an obvious one-line fix BEFORE tracing the data is Pattern Match Bias — trace upstream (DB/collector/field) first"
